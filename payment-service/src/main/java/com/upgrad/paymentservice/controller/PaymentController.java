...
public final class PaymentController {
  ...
  public PaymentResponse makePayment(@RequestBody final PaymentRequest paymentRequest) {
    try {
      log.info("Payment Service processing starts with userId::{}",paymentRequest.getUserId());
      ...
      log.error("Payment Service producing exception with userId::{}",paymentRequest.getUserId());
      return PaymentResponse.builder()
